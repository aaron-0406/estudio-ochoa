      ...
      <div className="row">
        <div className="col-12 col-md-6">
          ...
          <p className="text-justify">
            ...
            través de la cobranza judicial o extrajudicial. Nuestra experiencia
            ha permitido que logremos un porcentaje extraordinario de resultados
            favorables, así como, ha logrado que no existan conflictos de
            intereses en caso de que un mismo deudor mantenga varias deudas,
            aplicando un trato personalizado a cada cliente acreedor y una
            organizada labor de manejar los procesos judiciales o solicitudes de
          ...
          <p className="text-justify">
            ...
            nuestros clientes funcione óptimamente, tanto en moneda nacional
            como extranjero.
          </p>
          <Link
            to="/Contacto"
      ...
      <div className="row my-5">
        ...
        <div className="col-12 col-md-8">
          ...
          <p className="my-5">
            ...
            aseguramos de rematar los bienes en subasta para que con el producto
            de lo recaudado por cada uno logremos pagar la deuda.
          </p>
          <p className="fw-bold text-center">
          ...
          <p>
            Este tipo de cobranza infiere la búsqueda del deudor y solicitar vía
            telefónica, cartas, mensajes en redes sociales, el pago de su

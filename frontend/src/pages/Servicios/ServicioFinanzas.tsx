    ...
    <div className="container my-5">
      <div className="row">
        <div className="col-12 col-md-6">
          <h5 className="text-center fw-bold my-4">FINANZAS BANCA Y SEGUROS</h5>
          <p className="text-justify">
            Como parte de la formación de empresas y su funcionamiento, nuestro
            Estudio se encuentra familiarizado con la implementación de
            proyectos de financiamiento, así como, el uso de herramientas
            financieras de diversa índole.
          </p>
          <p className="text-justify">
            Por otro lado, nuestra experiencia en Derecho Bancario nos permite
            ofrecer nuestros servicios de asesoría referida al sector financiero
            y de seguros, garantizando la adecuada aplicación del ordenamiento
            establecido en la Ley General del Sistema Financiero y de Seguros y

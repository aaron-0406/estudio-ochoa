        ...
        <div className="row">
          <div className="col-12 col-md-6">
            ...
            <p className="text-justify">
              ...
              procedimientos específicos cuales son el proceso concursal
              Ordinario y el Concurso Preventivo.
            </p>
            <Link
              to="/Contacto"
        ...
        <div className="row my-5">
          ...
          <div className="col-12 col-md-8">
            ...
            <p className="text-justify my-5">
              Buscar la solución y conclusión del procedimiento concursal
              mediante flujos y excedentes que se logren.
            </p>
          </div>
          <div className="col-12 col-md-2"></div>
        </div>

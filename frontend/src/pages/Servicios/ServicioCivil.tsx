      ...
      <div className="row">
        <div className="col-12 col-md-6">
          ...
          <p className="text-justify">
            ...
            contratos regulados en nuestro ordenamiento civil vigente tales como
            Compra venta, arrendamiento, locación de servicios, fianza, entre
            otros, diseñando asimismo, estructuras contractuales atípicas que se
            adecuen a los requerimientos específicos de nuestros clientes.
          </p>
          <p className="text-justify">
            Esta área también proporciona asesoría en Derecho de Familia
            (divorcios de mutuo acuerdo notariales o municipales, o aquellos con
            causal), Sucesiones, Derechos reales, representación derechos reales
            de garantía y demás áreas.
          </p>
          <Link
            to="/Contacto"
      ...
      <div className="row my-5">
        ...
        <div className="col-12 col-md-8">
          ...
          <p className="text-justify my-5">
            ...
            de Predios podemos efectuar la inmatriculación del mismo realizando
            los trámites exigibles y en caso de que el área utilizada del predio
            no sea similar a la registrada realizamos la rectificación
            cumpliendo con los requisitos para ello.
          </p>
        </div>
        <div className="col-12 col-md-2"></div>
      </div>

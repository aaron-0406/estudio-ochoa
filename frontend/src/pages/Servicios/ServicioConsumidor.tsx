      ...
      <div className="row">
        <div className="col-12 col-md-6">
          ...
          <p className="text-justify">
            Defendemos la vulneración de las marcas, inventos, obras literarias,
            conocimientos ancestrales y diseños industriales, por citar algunos.
            Muchos de estos productos, protegidos por los derechos de propiedad
            intelectual, se han vuelto muy valiosos en nuestra sociedad.
          </p>
          <p className="text-justify">
            ...
            servicios financieros se ven involucradas en denuncias, justificadas
            o no, por violación a las normas de protección al consumidor, a
            pesar de poseer políticas de protección al consumidor.
          </p>
          <Link
            to="/Contacto"
      ...
      <div className="row my-5">
        ...
        <div className="col-12 col-md-8">
          ...
          <p>
            ...
            que pueda obtener el producto o el servicio en condiciones idóneas.
          </p>

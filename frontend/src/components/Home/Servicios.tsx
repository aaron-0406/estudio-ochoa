    ...
    <div className="hss container-fluid py-5">
      <div className="row text-center">
        <div className="hss-content col-12 col-md-6 py-5 shadow p-3 mb-5 bg-white rounded">
          ...
          <Link to="/Servicios/Recuperaciones" className="hss-content__title d-block fw-bold text-decoration-none px-3 mb-4">
          ...
          <Link to="/Servicios/Recuperaciones" className="hss-content__more text-decoration-none pb-2 fs-6">
            Leer Más
          </Link>
        </div>
        <div className="hss-content col-12 col-md-6 py-5 shadow p-3 mb-5 bg-white rounded">
          <FontAwesomeIcon className="pe-2" icon={faShoppingCart} color="#C17743" size="3x" />
          <Link to="/Servicios/Consumidor" className="hss-content__title d-block fw-bold text-decoration-none px-4 mb-4">
          ...
          <Link to="/Servicios/Consumidor" className="hss-content__more text-decoration-none pb-2 fs-6">
            Leer Más
          </Link>
        </div>
        <div className="hss-content col-12 col-md-6 py-5 shadow p-3 mb-5 bg-white rounded">
          ...
          <br />
          <br />
          <Link to="/Servicios/Civil" className="hss-content__title d-block fw-bold text-decoration-none px-3 mb-4">
            Civil
          </Link>
          ...
          <Link to="/Servicios/Civil" className="hss-content__more text-decoration-none pb-2 fs-6">
            Leer Más
          </Link>
        </div>
        <div className="hss-content col-12 col-md-6 py-5 shadow p-3 mb-5 bg-white rounded">
          ...
          <br />
          <br />
          <Link to="/Servicios/Penal" className="hss-content__title d-block fw-bold text-decoration-none px-3 mb-4">
            Penal
          </Link>
          ...
          <Link to="/Servicios/Penal" className="hss-content__more text-decoration-none pb-2 fs-6">
            Leer Más
          </Link>
        </div>
      </div>

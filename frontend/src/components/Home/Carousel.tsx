        ...
        <div className="carousel-inner">
          <div className="carousel-item active">
            ...
            <div className="home-carousel__content carousel-caption d-none d-md-flex flex-md-column justify-content-md-center h-100">
              ...
              <p className="pb-4 fw-light">
                En la noble y señorial ciudad de ICA y también en las pujantes
                ciudades de AYACUCHO y HUANCAYO, tiene notable y destacada
                presencia el Estudio Jurídico "OCHOA MALDONADO" integrado por
                una selecta plana de especialistas del derecho con más de 10
                años de experiencia.
              </p>
              <ul className="list-unstyled d-md-flex justify-content-center">
                <li>
                  <Link
                    to="/Historia"
                    className="home-carousel__content-boton1 text-decoration-none px-5 py-3 me-2 fw-light"
                  >
                    Conócenos
                  </Link>
                </li>
                <li>
                  <Link
                    to="/Equipo"
                    className="home-carousel__content-boton2 text-decoration-none px-5 py-3 ms-2 fw-light"
                  >
                    Equipo
                  </Link>
                </li>

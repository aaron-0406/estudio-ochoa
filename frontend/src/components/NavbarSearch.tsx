  ...
  return (
    <div ref={props.referencia} className="navbar-search">
      ...
      <ul ref={box_search} id="box-search" className="list-unstyled">
        ...
        <li>
          <a href="https://web.facebook.com/Estudio-Jur%C3%ADdico-Ochoa-Maldonado-Abogados-Sociedad-Civil-105613827900367/" target="_blank" rel="noreferrer">
            <FontAwesomeIcon className="ms-3 me-4" icon={faSearch} color="#C17743" size="lg" />
            FACEBOOK
          </a>
        </li>
        <li>
          <a href="https://www.instagram.com/estudiojuridicoochoam/" target="_blank" rel="noreferrer">
            <FontAwesomeIcon className="ms-3 me-4" icon={faSearch} color="#C17743" size="lg" />
            INSTAGRAM
          </a>
        </li>
        <li>
          <a rel="noreferrer" href="https://www.linkedin.com/in/estudio-jur%C3%ADdico-ochoa-maldonado-abogados-sociedad-civil-35b2041b3?lipi=urn%3Ali%3Apage%3Ad_flagship3_profile_view_base_contact_details%3BFEv%2BvHgSSY6DKBwDhf%2FIFw%3D%3D">
            <FontAwesomeIcon className="ms-3 me-4" icon={faSearch} color="#C17743" size="lg" />
            LINKEDIN
          </a>
        </li>
